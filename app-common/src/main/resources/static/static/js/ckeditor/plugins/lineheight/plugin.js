        ...
        editor.ui.addRichCombo( comboName,
            {
                ...
                className: 'cke_' + (styleType == 'size' ? 'fontSize' : 'lineheight'),
                panel :
                {
    ...
    CKEDITOR.plugins.add('lineheight',
        {
            ...
            {
                var config = editor.config;
                addCombo(editor, 'lineheight', 'lineheight', editor.lang, config.lineheight_sizes, config.fontSize_defaultLabel, config.lineheight_style);
            }
        });
})();
