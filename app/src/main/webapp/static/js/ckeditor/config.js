...
//	];
	...
	if(config.ckfinderPath){
		...
		config.filebrowserUploadUrl = config.ckfinderServletPath+'?command=QuickUpload&type=files&currentFolder='+config.ckfinderUploadPath;
		config.filebrowserImageUploadUrl = config.ckfinderServletPath+'?command=QuickUpload&type=images&currentFolder='+config.ckfinderUploadPath;
		config.filebrowserFlashUploadUrl = config.ckfinderServletPath+'?command=QuickUpload&type=flash&currentFolder='+config.ckfinderUploadPath;
