...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    mobileOrPhone: {//手机号码或固定电话验证
        validator: function(value, param){
            return (/^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(value)) || ( /^(\(\d{3,4}\)|\d{3,4}-|\s)?\d{7,14}$/.test(value));
        },
        message: '手机格式:11位手机号码; 电话格式:区号3位或4位,号码7位或8位,区号与号码之间用小括号或"-"隔开.'
    },
    empty: {
        validator: function (value, param) {
