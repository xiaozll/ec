...
(function () {
    ...
    e.extend(h.prototype, {type: 1, addClass: function (i) {
        ...
        if (c && (b.ie7Compat || b.ie6Compat))return function (j, k) {
            var l = this;
            if (j == 'class')l.$.className = k; else if (j == 'style')l.$.style.cssText = k; else if (j == 'tabindex')l.$.tabIndex = k; else if (j == 'checked')l.$.checked = k; else if (j == 'contenteditable')i.call(l, 'contentEditable', k); else i.apply(l, arguments);
            return l;
        ...
        if (c && (b.ie7Compat || b.ie6Compat))return function (j) {
            if (j == 'class')j = 'className'; else if (j == 'tabindex')j = 'tabIndex'; else if (j == 'contenteditable')j = 'contentEditable';
            i.call(this, j);
        }; else return i;
    ...
    (function () {
        ...
        function o(u) {
            ...
            return function (y) {
                if (w(y))return true;
                if (y.type == 3) {
                    if (c && x.test(y.getText()) && !v && !(u && y.getNext()))v = true; else if (y.hasAscendant('pre') || e.trim(y.getText()).length)return false;
        ...
        d.range.prototype = {clone: function () {
            ...
            if ((!u || y) && w && w.type == 3) {
                if (!x) {
                    ...
                    x = w.getIndex() + 1;
                    w = w.getParent();
                    if (C.startContainer.equals(C.endContainer))C.setEnd(z, C.endOffset - C.startOffset); else if (w.equals(C.endContainer))C.endOffset += 1;
                }
                C.setStart(w, x);
                if (y) {
                    C.collapse(true);
    ...
    (function () {
        j.add('image', {requires: ['dialog'], init: function (o) {
            ...
            function p(q) {
                ...
                if (r) {
                    if (q == 'left' || q == 'right'|| q == 'center')r.on('exec', function (s) {
                        var t = m(o), u;
                        if (t) {
//                            u = n(t);
//                            if (u == q) {
...
//                            } else t.setStyle('float', q);
                            ...
                            if ( u == q ) {
                                t.removeStyle( 'float' );
                                t.removeStyle( 'margin-left' );
                                t.removeStyle( 'margin-right' );
                                ...
                                t.removeStyle( 'float' );
                                t.setStyle( 'margin-left', 'auto' );
                                t.setStyle( 'margin-right', 'auto' );
                    ...
                    r.on('refresh', function (s) {
                        ...
                        if (t) {
                            u = n(t);
                            this.setState(u == q ? 1 : q == 'right' || q == 'left' || q == 'center'? 2 : 0);
                            s.cancel();
                        }
                    });
                }
        ...
        function G(N) {
            return function (O) {
                ...
                if (S && (S.name && S.name == 'br' || S.value && (T = S.value.match(E)))) {
                    var U = S;
                    if (!(T && T.index) && U == P[0])P[0] = N || c ? new a.htmlParser.text('\xa0') : new a.htmlParser.element('br', {}); else if (U.name == 'br')P.splice(Q - 1, 1); else U.value = U.value.replace(E, '');
                }
            };
        };
        var H = {elements: {}};
    ...
    (function () {
        ...
        a.dialog = function (Q, R) {
            ...
            function ak(aq) {
                ...
                if (ar == 9 || ar == 2228224 + 9) {
                    ...
                    if (at)e.setTimeout(at.click, 0, at); else if (ax.fire('cancel', {hide: true}).hide !== false)ax.hide();
                    Z = 1;
                } else return;
                al(aq);
            };
            function al(aq) {
                if (Y)aq.data.preventDefault(1); else if (Z)aq.data.stopPropagation();
            };
        ...
        a.dialog.prototype = {destroy: function () {
            ...
            var T = this;
            for (var R in T._.contents)for (var S in T._.contents[R])Q.call(T, T._.contents[R][S]);
            return T;
        }, reset: (function () {
            var Q = function (R) {
                ...
                if (c) {
                    ...
                    function N(O) {
                        if (I) {
                            ...
                            var S;
                            if (R && R.type && R.type != 'Control' && (S = R.createRange()) && (S = S.parentElement()) && (S = S.nodeName) && S.toLowerCase() in {input: 1, textarea: 1})return;
                            H = R && Q.getRanges()[0];
                            p.call(z);
                        }
                    };
