 ...
 */
package com.eryansky.common.orm.mybatis.interceptor.callable;

import com.eryansky.common.orm.mybatis.interceptor.callable.handler.CallableResultHandler;
import com.eryansky.common.orm.mybatis.interceptor.callable.handler.SimpleResultHandler;
import com.eryansky.common.orm.mybatis.interceptor.callable.support.PropertiesHelper;
...
public class CallableConvertInterceptor implements Interceptor {
    ...
    public void setProperties(Properties properties) {
        ...
        String dialectClass = propertiesHelper.getProperty("resultHandler", "com.eryansky.common.orm.mybatis.interceptor.callable.handler.SimpleResultHandler");
        try {
