 ...
 * @date 2020-02-12
 */
public class SeneitiveCompatiableStringSerializer extends JsonSerializer<String> implements ContextualSerializer {

    private SensitiveType type;

    public SeneitiveCompatiableStringSerializer() {
    }

    public SeneitiveCompatiableStringSerializer(final SensitiveType type) {
        this.type = type;
    }
    ...
    public void serialize(String value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        gen.writeStringField(fieldName + "Sensitive", SensitiveUtils.getSensitive(value, type));
    }
        ...
        if (property != null) { // 为空直接跳过
            if (Objects.equals(property.getType().getRawClass(), String.class)) { // 非 String 类直接跳过
                ...
                if (sensitiveInfo != null) { // 如果能得到注解，就将注解的 value 传入 SensitiveInfoSerialize
                    return new SeneitiveCompatiableStringSerializer(sensitiveInfo.value());
                }
            }
