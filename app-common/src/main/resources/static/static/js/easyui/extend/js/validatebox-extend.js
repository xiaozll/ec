...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    mobile: {
        validator: function (value, param) {
            return (length == 11 && /^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(value));
        },
        message: '正确的11位手机号码.'
    },
    phone: {//座机号码/固定电话验证
        validator: function(value, param){
            return /(^0[1-9]{1}\d{9,10}$)|^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(value);
        },
        message: '电话号码输入有误，匹配格式：固话为区号(3-4位)号码(7-9位),手机为:真实手机号.例如:"0791-88888888"'
    },
    mobileOrPhone: {//手机号码或固定电话验证
        validator: function(value, param){
            return (/^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(value)) || ( /(^0[1-9]{1}\d{9,10}$)|^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(value));
        },
    ...
    safepass_yc: {
        validator: function (value, param) {
            return safePassword_yc(value);
        },
        message: '密码由数字、字母、符号混排，至少8位.'
    },
    equalTo: {
        validator: function (value, param) {
...
/* 密码由数字、字母、符号混排，至少8位 */
var safePassword_yc = function (value) {
