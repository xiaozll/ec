...
//			sheet.autoSizeColumn((short) c,true);
	 ...
	 * @throws Exception
	 */
	public void exportToCustomExcel(String title, String creator, TableData tableData)
			throws Exception {
...
//			fileNames = new String(sFileName.getBytes("UTF-8"), "GBK"); // 处理中文文件名的问题
	 ...
	 *         bgcolor:#CAEAFE; </style>
	 */
	public void exportToCustomExcel(String title, String creator, List<TableData> tableDataLst)
			throws Exception {
