...
public interface UserDao extends CrudDao<User> {
    ...
    List<User> findByPasswords(Parameter parameter);
    ...
    List<User> findOrganUsersByOrganId(Parameter parameter);

    List<User> findOrganUsersByOrganCode(Parameter parameter);
